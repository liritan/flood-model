...
with tab4:
    st.header("⚡ Временные возмущения системы")
    ...
    if st.session_state.calculation_done:
        ...
        st.subheader("Описание возмущений")
        st.write("""
        **Временные возмущения fak₁-fak₆** - это функции времени, которые влияют на динамику системы:
        
        - **fak₁(t) = t² + 1** - квадратичный рост
        - **fak₂(t) = cos²(1.5πt - π/6)/4 + 0.2** - косинусоидальное возмущение  
        - **fak₃(t) = sin(πt - π/6)/2.5 + 0.3** - синусоидальное возмущение
        - **fak₄(t) = 2t - 1** - линейное возмущение
        - **fak₅(t) = cos²(1.5πt - π/6)/4** - косинусоидальное возмущение
        - **fak₆(t) = sin²(πt - π/6)/2.5 + 0.3** - синусоидальное возмущение
        
        Эти функции используются в правых частях дифференциальных уравнений системы.
        """)
        ...
        st.download_button(
            ...
            data=buf.getvalue(),
            file_name="график_временных_возмущений.png",
            mime="image/png",
